...
<title>Success</title>
	...
	<div id = "registration"><br>
		...
		<hr>
		<h2>Your Payment is Success.</br></h2>
		<img id = "green-tick" src="images/green_tick.png" ><br><br>
		
		<div class="clearfix">
			<button class="returnbtn"><a href="index.jsp" style="color:white;">Back to Home</a></button>
			<br>
			<button class="returnbtn"><a href="courier.jsp" style="color:white;">Delivery</a></button>
		</div><br><br>
